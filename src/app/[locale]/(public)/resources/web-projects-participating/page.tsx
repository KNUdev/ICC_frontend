...
export async function generateMetadata({
	...
	return {
		title: t('webProjectsPart.title'),
	}
}

export default function WebProjectsPart() {
	const t = useTranslations('public/resources')
	const items = t.raw('webProjectsPart.items') as { name: string; description: string }[]
		...
		<div>
			<section className={styles.historyPage + ' main-wrapper'} id='top'>
				<div className={styles.header}>
					...
					<h1 className={styles.title}>{t('webProjectsPart.title')}</h1>
				</div>
